...
from . import views
from .views import todas_avaliacoes, avaliacao_detalhes, logout_view,  sucesso_view, avaliacao_lider,  todas_avaliacoes_rh, detalhes_avaliacao_rh, realizar_avaliacao_colaborador, realizar_avaliacao_lider, salvar_avaliacao_colaborador, salvar_avaliacao_lider
urlpatterns = [
